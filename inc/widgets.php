...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		...
		register_sidebar( array(
			'name'          => __( 'Frontpage footer', 'understrap' ),
			'id'            => 'frontpagefooter',
			'description'   => 'Full sized footer widget for instagram feed',
				'before_widget'  => '<div id="frontpagefooter" class="footer-widget %2$s '. understrap_slbd_count_widgets( 'frontpagefooter' ) .'">',
				'after_widget'   => '</div><!-- .footer-widget -->',
				'before_title'   => '<h3 class="widget-title">',
				'after_title'    => '</h3>',
		) );
